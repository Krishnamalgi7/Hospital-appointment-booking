...
Hospitum Core is a production-grade Enterprise Hospital Appointment Booking and Management System built with **Django**, **MySQL**, **HTML5**, **CSS3**, and **Vanilla JavaScript**.
